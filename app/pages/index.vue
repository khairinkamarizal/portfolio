<template>
  <NuxtLayout name="simple">
    <template #default>
      ...
      <!-- ==================== HERO ==================== -->
      <section id="hero" aria-describedby="hero-bio" class="relative min-h-[88vh] flex flex-col justify-between px-8 pt-8 pb-10 border-b border-black/8 dark:border-white/8">
