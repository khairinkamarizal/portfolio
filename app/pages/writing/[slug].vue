<template>
  <NuxtLayout name="simple">
    ...
    <template #default>
      ...
      <div id="main-content" class="px-page pt-10 pb-16">
        ...
        <div class="lg:grid lg:grid-cols-4 lg:gap-12">
          ...
          <div class="lg:col-span-3 flex flex-col gap-8">
            ...
            <header v-if="post" class="mb-10 pb-8 border-b border-black/8 dark:border-white/8">
              <p class="font-mono text-[9px] tracking-[0.3em] uppercase opacity-20 mb-3">Writing</p>
          ...
          <div class="hidden lg:block lg:col-span-1">
            <div class="sticky top-8 toc-links">
