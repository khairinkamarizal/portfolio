...
.contact-submit { width: 100%; display: flex; justify-content: space-between; align-items: center; padding: 1.4rem 0; border-bottom: 2px solid var(--ink); font-size: clamp(1.8rem, 3.5vw, 3.5rem); line-height: 1; font-weight: 500; text-align: left; }
.contact-submit svg { width: 2.5rem; height: 2.5rem; transition: transform 180ms ease; }
.contact-submit:hover svg { transform: translate(0.25rem, -0.25rem); }
